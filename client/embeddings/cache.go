...
var errEmptyEmbedding = errors.New("flux: embedder returned no embeddings")
...
func (sp *EmbeddingCachedProvider) Chat(ctx context.Context, messages []core.FluxMessage, opts core.ChatOptions) (*core.FluxResponse, error) {
...
func (sp *EmbeddingCachedProvider) StreamChat(ctx context.Context, messages []core.FluxMessage, opts core.ChatOptions) (*core.StreamResult, error) {
...
// contents.
func (sp *EmbeddingCachedProvider) embed(ctx context.Context, messages []core.FluxMessage, opts core.ChatOptions) ([]float32, error) {
...
func (sp *EmbeddingCachedProvider) lookup(vec []float32) (*core.FluxResponse, bool) {
	sp.mu.Lock()
	defer sp.mu.Unlock()
...
func (sp *EmbeddingCachedProvider) store(vec []float32, resp *core.FluxResponse) {
	sp.mu.Lock()
	defer sp.mu.Unlock()
