		...
		Interactions: []Interaction{
			{
				...
				Response: RecordedResponse{
					...
					Usage:        &FluxUsage{PromptTokens: 5, CompletionTokens: 3, TotalTokens: 8},
				},
			},
		},
	}
...
func TestCassetteMultipleInteractions(t *testing.T) {
	...
	c := &Cassette{
		...
		Interactions: []Interaction{
			{
				Request:  RecordedRequest{Messages: []FluxMessage{{Role: "user", Content: "Q1"}}, Model: "claude-3"},
				Response: RecordedResponse{Content: "A1"},
			},
			{
				Request:  RecordedRequest{Messages: []FluxMessage{{Role: "user", Content: "Q2"}}, Model: "claude-3"},
				Response: RecordedResponse{Content: "A2"},
			},
			{
				Request:  RecordedRequest{Messages: []FluxMessage{{Role: "user", Content: "Q3"}}, Model: "claude-3"},
...
func TestCassetteWithToolCalls(t *testing.T) {
	...
	c := &Cassette{
		...
		Interactions: []Interaction{
			{
				Request: RecordedRequest{
					Messages: []FluxMessage{{Role: "user", Content: "Use a tool"}},
					Model:    "gpt-4o",
				},
				Response: RecordedResponse{
					ToolCalls: []ToolCall{
...
func TestCassetteWithError(t *testing.T) {
	...
	c := &Cassette{
		...
		Interactions: []Interaction{
			{
				Request: RecordedRequest{
					Messages: []FluxMessage{{Role: "user", Content: "fail"}},
					Model:    "gpt-4o",
				},
				Response: RecordedResponse{
...
func TestRequestHashDifferentInputs(t *testing.T) {
	...
	h1 := requestHash([]FluxMessage{{Role: "user", Content: "Hello"}}, opts)
	h2 := requestHash([]FluxMessage{{Role: "user", Content: "Different"}}, opts)
	if h1 == h2 {
