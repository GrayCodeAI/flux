...
type ConversationCondenser interface {
	...
	Condense(ctx context.Context, messages []FluxMessage, opts CondenseOptions) ([]FluxMessage, error)
}
...
func (c *LLMSummarizingCondenser) Condense(ctx context.Context, messages []FluxMessage, opts CondenseOptions) ([]FluxMessage, error) {
	...
	out := make([]FluxMessage, 0, keepFirst+1+tailCount)
...
func (c *LLMSummarizingCondenser) summarize(ctx context.Context, span []FluxMessage) (string, error) {
	...
	req := []FluxMessage{{Role: "user", Content: b.String()}}
	opts := ChatOptions{
...
func (p *CondensingProvider) Chat(ctx context.Context, messages []FluxMessage, opts ChatOptions) (*FluxResponse, error) {
...
func (p *CondensingProvider) StreamChat(ctx context.Context, messages []FluxMessage, opts ChatOptions) (*StreamResult, error) {
	msgs, err := p.condense(ctx, messages)
	if err != nil {
		return nil, err
	}
...
func (p *CondensingProvider) condense(ctx context.Context, messages []FluxMessage) ([]FluxMessage, error) {
