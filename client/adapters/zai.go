...
func (c *ZAIClient) Chat(ctx context.Context, messages []core.GraycodeRouterMessage, opts core.ChatOptions) (*core.GraycodeRouterResponse, error) {
...
func zaiRetryableChatError(err error) bool {
	...
	// Structured path: trust core.GraycodeRouterError's IsRetriable
