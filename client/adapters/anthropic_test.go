...
func TestAnthropicClient_Chat_Success(t *testing.T) {
	...
	resp, err := c.Chat(context.Background(), []core.FluxMessage{{Role: "user", Content: "Hi"}}, core.ChatOptions{Model: "claude-sonnet-4-20250514", MaxTokens: 256})
	if err != nil {
		t.Fatalf("Chat: %v", err)
	}
...
func TestAnthropicClient_Chat_EmptyModel(t *testing.T) {
	t.Parallel()
	c := NewAnthropicClient("key", "")
	_, err := c.Chat(context.Background(), []core.FluxMessage{{Role: "user", Content: "Hi"}}, core.ChatOptions{Model: ""})
	if err == nil {
...
func TestAnthropicClient_Chat_APIError(t *testing.T) {
	...
	c.SetRetry(core.RetryConfig{RetryConfig: types.RetryConfig{MaxRetries: 0}})
	c.httpClient = &http.Client{Transport: transport}
	_, err := c.Chat(context.Background(), []core.FluxMessage{{Role: "user", Content: "Hi"}}, core.ChatOptions{Model: "claude-sonnet-4-20250514", MaxTokens: 256})
	if err == nil {
...
func TestAnthropicClient_StreamChat_Success(t *testing.T) {
	...
	c.SetRetry(core.RetryConfig{RetryConfig: types.RetryConfig{MaxRetries: 0}})
	c.httpClient = &http.Client{Transport: transport}
	result, err := c.StreamChat(context.Background(), []core.FluxMessage{{Role: "user", Content: "Hi"}}, core.ChatOptions{Model: "claude-sonnet-4-20250514", MaxTokens: 256})
	if err != nil {
...
func TestAnthropicClient_StreamChat_EmptyModel(t *testing.T) {
	t.Parallel()
	c := NewAnthropicClient("key", "")
	_, err := c.StreamChat(context.Background(), []core.FluxMessage{{Role: "user", Content: "Hi"}}, core.ChatOptions{Model: ""})
	if err == nil {
		t.Fatal("expected error for empty model")
	}
}
...
func TestAnthropicClient_CountTokens_Success(t *testing.T) {
	...
	c.SetRetry(core.RetryConfig{RetryConfig: types.RetryConfig{MaxRetries: 0}})
	c.httpClient = &http.Client{Transport: transport}
	result, err := c.CountTokens(context.Background(), []core.FluxMessage{{Role: "user", Content: "Count me"}}, core.ChatOptions{Model: "claude-sonnet-4-20250514"})
	if err != nil {
...
func TestAnthropicClient_CountTokens_EmptyModel(t *testing.T) {
	t.Parallel()
	c := NewAnthropicClient("key", "")
	_, err := c.CountTokens(context.Background(), []core.FluxMessage{{Role: "user", Content: "Hi"}}, core.ChatOptions{Model: ""})
	if err == nil {
		t.Fatal("expected error for empty model")
	}
}
...
func TestAnthropicClient_CountTokens_APIError(t *testing.T) {
	...
	c.SetRetry(core.RetryConfig{RetryConfig: types.RetryConfig{MaxRetries: 0}})
	c.httpClient = &http.Client{Transport: transport}
	_, err := c.CountTokens(context.Background(), []core.FluxMessage{{Role: "user", Content: "Hi"}}, core.ChatOptions{Model: "claude-invalid"})
	if err == nil {
...
func TestConvertToAnthropicTools(t *testing.T) {
	t.Parallel()
	result := ConvertToAnthropicTools([]core.FluxTool{
...
func TestBuildAnthropicMessages_Basic(t *testing.T) {
	t.Parallel()
	msgs, system := BuildAnthropicMessages([]core.FluxMessage{
...
func TestBuildAnthropicMessages_ToolUse(t *testing.T) {
	t.Parallel()
	msgs, _ := BuildAnthropicMessages([]core.FluxMessage{
...
func TestBuildAnthropicRequest_ResponseFormat(t *testing.T) {
	t.Parallel()
	c := NewAnthropicClient("key", "")
	_, _, err := c.BuildAnthropicRequest(context.Background(), []core.FluxMessage{{Role: "user", Content: "Hi"}}, core.ChatOptions{
...
func TestBuildAnthropicRequest_ResponseFormatJSONSchema(t *testing.T) {
	t.Parallel()
	c := NewAnthropicClient("key", "")
	req, _, err := c.BuildAnthropicRequest(context.Background(), []core.FluxMessage{{Role: "user", Content: "Hi"}}, core.ChatOptions{
		Model:          "claude-sonnet-4-20250514",
		MaxTokens:      256,
...
func TestAnthropicClient_Chat_DefaultMaxTokens(t *testing.T) {
	...
	c.SetRetry(core.RetryConfig{RetryConfig: types.RetryConfig{MaxRetries: 0}})
	c.httpClient = &http.Client{Transport: transport}
	_, err := c.Chat(context.Background(), []core.FluxMessage{{Role: "user", Content: "Hi"}}, core.ChatOptions{Model: "claude-sonnet-4-20250514"})
	if err != nil {
		t.Fatalf("Chat: %v", err)
	}
}
...
func TestAnthropicClient_Chat_ResponseFormatJSONSchema(t *testing.T) {
	...
	c.SetRetry(core.RetryConfig{RetryConfig: types.RetryConfig{MaxRetries: 0}})
	c.httpClient = &http.Client{Transport: transport}
	_, err := c.Chat(context.Background(), []core.FluxMessage{{Role: "user", Content: "Hi"}}, core.ChatOptions{
		Model:          "claude-sonnet-4-20250514",
		MaxTokens:      256,
...
func TestAnthropicClient_Chat_SystemPrompt(t *testing.T) {
	...
	c.SetRetry(core.RetryConfig{RetryConfig: types.RetryConfig{MaxRetries: 0}})
	c.httpClient = &http.Client{Transport: transport}
	_, err := c.Chat(context.Background(), []core.FluxMessage{
...
func TestBuildAnthropicCachedRequest_WithSystem(t *testing.T) {
	t.Parallel()
	req := BuildAnthropicCachedRequest(
		[]core.FluxMessage{{Role: "system", Content: "You are helpful"}},
		"claude-3", 256, nil, false, nil, nil, nil, nil, nil, nil,
	)
