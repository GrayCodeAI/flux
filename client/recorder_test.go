...
func TestRecorderHashBasedLookup(t *testing.T) {
	...
	_, err = rec.Chat(ctx, []FluxMessage{{Role: "user", Content: "question A"}}, opts)
	if err != nil {
		t.Fatalf("Chat() A error: %v", err)
	}

	mock.Response = "response B"
	_, err = rec.Chat(ctx, []FluxMessage{{Role: "user", Content: "question B"}}, opts)
	if err != nil {
	...
	resp, err := rec2.Chat(ctx, []FluxMessage{{Role: "user", Content: "question B"}}, opts)
	if err != nil {
	...
	// Request A second
	resp, err = rec2.Chat(ctx, []FluxMessage{{Role: "user", Content: "question A"}}, opts)
	if err != nil {
...
func TestRecorderStreamRecord(t *testing.T) {
	...
	ctx := context.Background()
	msgs := []FluxMessage{{Role: "user", Content: "stream me"}}
	opts := ChatOptions{Model: "m"}
...
func TestRecorderStreamReplay(t *testing.T) {
	...
	ctx := context.Background()
	msgs := []FluxMessage{{Role: "user", Content: "stream"}}
	opts := ChatOptions{Model: "m"}
...
func TestRecorderRedactor(t *testing.T) {
	...
	ctx := context.Background()
	msgs := []FluxMessage{{Role: "user", Content: "show secret"}}
	opts := ChatOptions{Model: "m"}
