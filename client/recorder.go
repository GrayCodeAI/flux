...
func (r *RecorderProvider) Chat(ctx context.Context, messages []FluxMessage, opts ChatOptions) (*FluxResponse, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *RecorderProvider) StreamChat(ctx context.Context, messages []FluxMessage, opts ChatOptions) (*StreamResult, error) {
...
func (r *RecorderProvider) checkReplay(messages []FluxMessage, opts ChatOptions) (string, *StreamResult, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *RecorderProvider) replay(hash string) (*FluxResponse, error) {
...
// interactionToResponse converts a RecordedResponse to an FluxResponse.
func (r *RecorderProvider) interactionToResponse(resp RecordedResponse) (*FluxResponse, error) {
	if resp.Error != "" {
...
func (r *RecorderProvider) syntheticStream(ctx context.Context, resp *FluxResponse) *StreamResult {
	streamCtx, cancel := context.WithCancel(ctx)
	ch := make(chan FluxStreamEvent, 10)
