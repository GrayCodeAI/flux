// Package probehttp contains shared helpers for the flux credential-probe
...
// DefaultClient is the shared *http.Client used by probe code in the flux
...
// UserAgent returns the standard flux User-Agent string for probe traffic.
func UserAgent() string { return "flux-probe/1.0" }
