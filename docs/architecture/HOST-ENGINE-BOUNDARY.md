...
Hawk (face: UX, session, tools, permissions)
  ...
  v
github.com/GrayCodeAI/flux/engine  [contract v2]
  |
...
explicit model is a hard constraint unless the host enables fallback. Flux
...
The boundary is delivered Flux-first:
