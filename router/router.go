...
func (r *Router) Chat(ctx context.Context, messages []client.FluxMessage, opts client.ChatOptions) (*client.FluxResponse, error) {
...
func (r *Router) StreamChat(ctx context.Context, messages []client.FluxMessage, opts client.ChatOptions) (*client.StreamResult, error) {
	provider, retry := r.selectProvider()
	r.stratState.beginInFlight(provider.Name())
	start := time.Now()
...
func (r *Router) chatWithRetry(ctx context.Context, p client.Provider, messages []client.FluxMessage, opts client.ChatOptions, cfg RetryConfig) (*client.FluxResponse, error) {
	var lastErr error
...
func (r *Router) streamWithRetry(ctx context.Context, p client.Provider, messages []client.FluxMessage, opts client.ChatOptions, cfg RetryConfig) (*client.StreamResult, error) {
	var lastErr error
	for attempt := 0; attempt <= cfg.MaxRetries; attempt++ {
...
func (r *Router) recordUsage(name string, resp *client.FluxResponse) {
