...
// RoleRouter wraps a core.Provider and overrides core.ChatOptions.Model with the model
...
// TracingProvider: it is additive and does not change core.ChatOptions semantics.
type RoleRouter struct {
	inner core.Provider
	roles ModelRoles
}

// Compile-time check that RoleRouter implements core.Provider.
var _ core.Provider = (*RoleRouter)(nil)
...
func NewRoleRouter(inner core.Provider, roles ModelRoles) (*RoleRouter, error) {
	if inner == nil {
		return nil, errors.New("flux: NewRoleRouter inner provider must not be nil")
	}
...
func (r *RoleRouter) Chat(ctx context.Context, messages []core.FluxMessage, opts core.ChatOptions) (*core.FluxResponse, error) {
...
// delegates to the inner provider.
func (r *RoleRouter) StreamChat(ctx context.Context, messages []core.FluxMessage, opts core.ChatOptions) (*core.StreamResult, error) {
...
// untouched.
func (r *RoleRouter) applyRole(ctx context.Context, opts core.ChatOptions) core.ChatOptions {
