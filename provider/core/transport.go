...
// Version is set by the root flux package's init() from the VERSION file
// (via the provider runtime's SetVersion). Default is "dev".
var Version = "dev"
...
func UserAgent() string { return "flux/" + Version }
