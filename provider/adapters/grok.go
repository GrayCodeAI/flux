...
// NewGrokClient builds an xAI (Grok) provider provider.
...
func (c *GrokClient) Chat(ctx context.Context, messages []core.FluxMessage, opts core.ChatOptions) (*core.FluxResponse, error) {
	return c.openAI.Chat(ctx, messages, opts)
}

func (c *GrokClient) StreamChat(ctx context.Context, messages []core.FluxMessage, opts core.ChatOptions) (*core.StreamResult, error) {
