...
// NewOllamaClient builds an Ollama provider provider.
...
func (c *OllamaClient) Chat(ctx context.Context, messages []core.FluxMessage, opts core.ChatOptions) (*core.FluxResponse, error) {
	return c.openAI.Chat(ctx, messages, opts)
}

func (c *OllamaClient) StreamChat(ctx context.Context, messages []core.FluxMessage, opts core.ChatOptions) (*core.StreamResult, error) {
