...
func defaultProviders() map[string]Provider {
	return map[string]Provider{
		...
		"concentrate":            {ID: "concentrate", Name: "Concentrate AI"},
...
func defaultDeployments() map[string]Deployment {
	return map[string]Deployment{
		...
		"concentrate-direct":            deployment("concentrate-direct", "Concentrate AI", "concentrate", "openai-chat-completions", "concentrate", NativeModelIDDiscovered),
